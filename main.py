...
app.config['MAIL_USERNAME'] = 'devrahul4798@gmail.com'
app.config['MAIL_PASSWORD'] = 'rahkavlit'
...
def respond():
    msg = Message('Hello from the other side!', sender =   'devrahul4798@gmail.com', recipients = ['devrahul4798@gmail.com'])
    msg.body = "TEST MAIL CHECK"
    mail.send(msg)
    return "Message sent!"
